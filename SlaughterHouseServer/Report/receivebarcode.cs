...
namespace SlaughterHouseServer.Report {
    ...
    public class receivebarcode : ReportClass {
        
        public receivebarcode() {
        }
        
        public override string ResourceName {
            get {
                return "receivebarcode.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "SlaughterHouseServer.Report.receivebarcode.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedreceivebarcode : Component, ICachedReport {
        
        public Cachedreceivebarcode() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            receivebarcode rpt = new receivebarcode();
            rpt.Site = this.Site;
            return rpt;
        }
